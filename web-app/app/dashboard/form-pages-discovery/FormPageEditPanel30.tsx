    ...
    <div style={{ maxWidth: '1600px', margin: '0 auto' }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex' }}>
              ...
              <div style={{
                ...
                {!specContent ? (
                  ...
                  <div style={{
                    ...
                    <p style={{ color: getTheme().colors.textSecondary, marginBottom: '12px' }}>
          ...
          {/* Right Column - Steps */}
          <div style={{ width: '420px', flexShrink: 0, padding: '28px', minWidth: 0, background: isLightTheme() ? '#dbeafe' : 'rgba(59, 130, 246, 0.08)' }}>
