        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '0', minHeight: '500px' }}>
            ...
            <div style={{ 
              ...
              background: isLightTheme() ? '#f5f3ff' : 'rgba(139, 92, 246, 0.05)'
            }}>
              {/* Hierarchy Info */}
              <div style={{
                ...
                <h4 style={{ margin: '0 0 16px', fontSize: '13px', color: isLightTheme() ? '#6d28d9' : '#a78bfa', textTransform: 'uppercase', letterSpacing: '1px', fontWeight: 600 }}>Hierarchy</h4>
              ...
              <div style={{
                ...
                <h4 style={{ margin: '0 0 12px', fontSize: '13px', color: isLightTheme() ? '#6d28d9' : '#a78bfa', textTransform: 'uppercase', letterSpacing: '1px', fontWeight: 600 }}>URL</h4>
