...
export default function DashboardPage() {
  ...
  // Theme configuration - Refined slate/indigo (synced with layout.tsx)
  const theme = {
    name: 'Slate',
    colors: {
  ...
  const getBgColor = (level: 'card' | 'section' | 'input' | 'header' | 'hover' | 'muted') => {
    switch (level) {
      ...
      case 'section': return '#f8fafc'
      case 'input': return '#ffffff'
      case 'header': return '#f8fafc'
      case 'hover': return '#f1f5f9'
      case 'muted': return '#f8fafc'
    ...
    <div style={{ width: '100%' }}>
        ...
        <div style={{
          ...
          <div 
            ...
            style={{
              ...
              borderBottom: isDiscoveryExpanded ? '1px solid #e2e8f0' : 'none',
        ...
        {(isDiscoveryExpanded || isDiscovering) && (
          networks.length === 0 ? (
            <div style={{
              ...
              <h3 style={{ margin: '0 0 12px', fontSize: '20px', color: '#0f172a', fontWeight: 600 }}>No Networks Found</h3>
              <p style={{ margin: 0, color: '#64748b', fontSize: '15px' }}>
                Open the <strong style={{ color: '#0f172a' }}>Test Sites</strong> tab from the sidebar to add your first test site.
              </p>
            </div>
          ) : (
            <>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
          <div>
            <h2 style={{ margin: 0, fontSize: '18px', color: '#0f172a', fontWeight: 600, letterSpacing: '-0.3px' }}>
          ...
          {formPages.length > 10 && (
            <span style={{ fontSize: '13px', color: '#64748b', background: '#f8fafc', padding: '6px 12px', borderRadius: '16px', border: '1px solid #e2e8f0' }}>
        ...
        {loadingFormPages ? (
          ...
          <div style={{
            ...
            <div style={{ fontSize: '48px', marginBottom: '20px' }}>📋</div>
            <p style={{ margin: 0, fontSize: '16px', color: '#0f172a', fontWeight: 500 }}>No form pages discovered yet</p>
            <p style={{ margin: '10px 0 0', fontSize: '14px', color: '#64748b' }}>Expand the discovery section above and start a discovery to find form pages</p>
          </div>
        ) : (
          <div style={{
            maxHeight: '700px',
                          ...
                          return (
                            <tr 
                              ...
                              style={{
                                transition: 'all 0.15s ease',
                                cursor: 'pointer',
                                background: currentIndex % 2 === 0 ? '#ffffff' : '#f8fafc'
                              }}
                            ...
                            >
                              <td style={{
                                ...
                                <strong style={{ fontSize: '14px', fontWeight: 600, color: '#0f172a' }}>{form.form_name}</strong>
