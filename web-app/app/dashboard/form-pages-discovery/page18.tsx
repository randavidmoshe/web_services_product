      ...
      <div style={{ maxWidth: '1600px', margin: '0 auto' }}>
        ...
        <div style={{
          background: isLightTheme() 
            ? 'linear-gradient(135deg, rgba(235, 240, 247, 0.98) 0%, rgba(235, 240, 247, 0.95) 100%)'
          ...
          <div style={{ display: 'flex', gap: '0', minHeight: '500px' }}>
            ...
            {/* Right Column - Steps */}
            <div style={{ flex: 1, padding: '28px', minWidth: 0, background: isLightTheme() ? '#eff6ff' : 'rgba(59, 130, 246, 0.05)' }}>
                    ...
                    <div 
                      ...
                      style={{
                        background: expandedSteps.has(index) 
                          ...
                          : (isLightTheme() ? 'rgba(235, 240, 247, 0.95)' : 'rgba(255,255,255,0.03)'),
                            ...
                            <div style={{ flex: 2 }}>
                              ...
                              <input
                                ...
                                style={{
                                  ...
                                  fontSize: '16px',
                                  boxSizing: 'border-box',
                                  background: isLightTheme() ? 'rgba(235, 240, 247, 0.9)' : 'rgba(255,255,255,0.05)',
            ...
            <>
              ...
              <div style={{ marginBottom: '16px' }}>
                ...
                <div style={{ 
                  ...
                  borderRadius: '8px',
                  overflow: 'hidden',
                  background: isLightTheme() ? 'rgba(235, 240, 247, 0.9)' : 'rgba(255,255,255,0.02)',
                  boxShadow: isLightTheme() 
                ...
                {[...formPages].sort((a, b) => {
                  ...
                  <tr 
                    ...
                    style={{
                      ...
                      cursor: 'pointer',
                      background: isLightTheme() 
                        ? (index % 2 === 0 ? 'rgba(235, 240, 247, 0.95)' : 'rgba(228, 234, 242, 0.9)')
