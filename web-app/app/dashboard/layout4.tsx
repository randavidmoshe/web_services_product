      ...
      <div style={{ display: 'flex', minHeight: 'calc(100vh - 70px)' }}>
        ...
        <div style={{
          ...
          <div style={{ padding: '20px 20px', borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              <div style={{
                ...
                <span style={{ color: '#fff', fontSize: '14px', fontWeight: 700 }}>Q</span>
              </div>
              <span style={{ fontSize: '16px', fontWeight: 700, color: '#fff', letterSpacing: '-0.3px' }}>Quattera</span>
              <span style={{ fontSize: '9px', fontWeight: 600, color: '#818cf8', background: 'rgba(99,102,241,0.15)', padding: '2px 6px', borderRadius: '4px', marginLeft: 'auto' }}>AI</span>
            </div>
          </div>
          ...
          <div style={{ flex: 1, padding: '16px 12px', overflowY: 'auto' }}>
            ...
            {/* Dashboard */}
            <div 
              onClick={() => router.push('/dashboard/project-dashboard')}
              className="sidebar-item"
              style={{ ...sidebarItemStyle, background: isActiveRoute('project-dashboard') ? 'rgba(255,255,255,0.1)' : 'transparent', borderColor: isActiveRoute('project-dashboard') ? 'rgba(99,102,241,0.5)' : 'transparent' }}
            >
              <div style={{ ...sidebarIconStyle, background: isActiveRoute('project-dashboard') ? 'linear-gradient(135deg, #6366f1, #818cf8)' : 'rgba(255,255,255,0.06)', boxShadow: 'none' }}>
                <span>📊</span>
              </div>
              <span style={{ color: isActiveRoute('project-dashboard') ? '#fff' : '#94a3b8', fontWeight: isActiveRoute('project-dashboard') ? 600 : 500 }}>Dashboard</span>
            </div>

            {/* Team Members - Global (admin only) */}
            {(userRole === 'admin' || userRole === 'super_admin') && (
              <div 
                onClick={() => router.push('/users')}
                className="sidebar-item"
                style={{ ...sidebarItemStyle, background: pathname === '/users' ? 'rgba(255,255,255,0.1)' : 'transparent', borderColor: pathname === '/users' ? 'rgba(99,102,241,0.5)' : 'transparent' }}
              >
                <div style={{ ...sidebarIconStyle, background: pathname === '/users' ? 'linear-gradient(135deg, #6366f1, #818cf8)' : 'rgba(255,255,255,0.06)', boxShadow: 'none' }}>
                  <span>👥</span>
                </div>
                <span style={{ color: pathname === '/users' ? '#fff' : '#94a3b8', fontWeight: pathname === '/users' ? 600 : 500 }}>Team Members</span>
              </div>
            )}

            {/* DISCOVERY section */}
            <div style={sectionLabelStyle}>Discovery</div>

            {/* Discovery items - conditional on project type */}
            {activeProject?.project_type === 'dynamic_content'
              ? (
                <div 
                  onClick={() => router.push('/dashboard/test-pages')}
                  className="sidebar-item"
                  style={{ ...sidebarItemStyle, background: isActiveRoute('test-pages') ? 'rgba(255,255,255,0.1)' : 'transparent', borderColor: isActiveRoute('test-pages') ? 'rgba(99,102,241,0.5)' : 'transparent' }}
                >
                  <div style={{ ...sidebarIconStyle, background: isActiveRoute('test-pages') ? 'linear-gradient(135deg, #6366f1, #818cf8)' : 'rgba(255,255,255,0.06)', boxShadow: 'none' }}>
                    <span>🧪</span>
                  </div>
                  <span style={{ color: isActiveRoute('test-pages') ? '#fff' : '#94a3b8', fontWeight: isActiveRoute('test-pages') ? 600 : 500 }}>Test Pages</span>
                </div>
              ) : (
                <>
                  <div 
                    ...
                    className="sidebar-item"
                    style={{ ...sidebarItemStyle, background: isActiveRoute('form-pages-discovery') ? 'rgba(255,255,255,0.1)' : 'transparent', borderColor: isActiveRoute('form-pages-discovery') ? 'rgba(99,102,241,0.5)' : 'transparent' }}
                  >
                    <div style={{ ...sidebarIconStyle, background: isActiveRoute('form-pages-discovery') ? 'linear-gradient(135deg, #6366f1, #818cf8)' : 'rgba(255,255,255,0.06)', boxShadow: 'none' }}>
                      <span>🔍</span>
                    </div>
                    <span style={{ color: isActiveRoute('form-pages-discovery') ? '#fff' : '#94a3b8', fontWeight: isActiveRoute('form-pages-discovery') ? 600 : 500 }}>Form Pages</span>
                  </div>
                  <div 
                    onClick={() => router.push('/dashboard/custom-tests')}
                    className="sidebar-item"
                    style={{ ...sidebarItemStyle, background: isActiveRoute('custom-tests') ? 'rgba(255,255,255,0.1)' : 'transparent', borderColor: isActiveRoute('custom-tests') ? 'rgba(99,102,241,0.5)' : 'transparent' }}
                  >
                    <div style={{ ...sidebarIconStyle, background: isActiveRoute('custom-tests') ? 'linear-gradient(135deg, #6366f1, #818cf8)' : 'rgba(255,255,255,0.06)', boxShadow: 'none' }}>
                      <span>🧪</span>
                    </div>
                    <span style={{ color: isActiveRoute('custom-tests') ? '#fff' : '#94a3b8', fontWeight: isActiveRoute('custom-tests') ? 600 : 500 }}>Custom Tests</span>
                  </div>
                </>
              )
            }
            ...
            {/* TESTING section */}
            <div style={sectionLabelStyle}>Testing</div>
            ...
            {[
              ...
              <div 
                ...
                className="sidebar-item"
                style={{ ...sidebarItemStyle, background: isActiveRoute(item.id) ? 'rgba(255,255,255,0.1)' : 'transparent', borderColor: isActiveRoute(item.id) ? 'rgba(99,102,241,0.5)' : 'transparent' }}
              >
                <div style={{ ...sidebarIconStyle, background: isActiveRoute(item.id) ? 'linear-gradient(135deg, #6366f1, #818cf8)' : 'rgba(255,255,255,0.06)', boxShadow: 'none' }}>
                  <span>{item.icon}</span>
                </div>
                <span style={{ color: isActiveRoute(item.id) ? '#fff' : '#94a3b8', fontWeight: isActiveRoute(item.id) ? 600 : 500 }}>{item.label}</span>
              </div>
            ))}
            ...
            <div 
              ...
              className="sidebar-item"
              style={{ ...sidebarItemStyle, background: isActiveRoute('logs') ? 'rgba(255,255,255,0.1)' : 'transparent', borderColor: isActiveRoute('logs') ? 'rgba(99,102,241,0.5)' : 'transparent' }}
            >
              <div style={{ ...sidebarIconStyle, background: isActiveRoute('logs') ? 'linear-gradient(135deg, #6366f1, #818cf8)' : 'rgba(255,255,255,0.06)', boxShadow: 'none' }}>
                <span>📋</span>
              </div>
              <span style={{ color: isActiveRoute('logs') ? '#fff' : '#94a3b8', fontWeight: isActiveRoute('logs') ? 600 : 500 }}>Logs</span>
            </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <div style={{
                  ...
                  background: agentStatus === 'online' ? '#22c55e' : '#6b7280',
                  boxShadow: agentStatus === 'online' ? '0 0 8px rgba(34,197,94,0.6)' : 'none',
                  animation: agentStatus === 'online' ? 'pulse 1.5s infinite' : 'none'
                }} />
              ...
              <span
                onClick={() => window.open('/api/installer/download/linux', '_blank')}
                style={{ fontSize: '11px', color: '#818cf8', cursor: 'pointer', fontWeight: 500, display: 'flex', alignItems: 'center', gap: '4px' }}
              >
                ⬇ Download
              </span>
            </div>
